    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-xl font-bold text-gray-800">Add New Job</h1>
          <p className="text-xs text-[#1E90FF] mt-0.5">Post a new job announcement for SkillBridge graduates</p>
        </div>
        ...
        <div className="flex border-b border-gray-200 mb-6 overflow-x-auto">
          {TABS.map((t, i) => (
            <button key={t} onClick={() => setTab(t)}
              ...
              {isComplete(t) ? <CheckCircle size={14} className="text-emerald-500" /> : null}
              {t}
            </button>
          ))}
        </div>
        ...
        {tab === "Review" && (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 max-w-2xl space-y-5">
            <div>
              ...
              <p className="text-xs text-gray-400">Check all details before publishing</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-gray-50 rounded-xl">
                ...
                {requirements.filter(Boolean).length > 3 && <p className="text-[11px] text-gray-400">+{requirements.filter(Boolean).length - 3} more</p>}
              </div>
              <div className="p-3 bg-gray-50 rounded-xl">
                ...
                {responsibilities.filter(Boolean).length > 3 && <p className="text-[11px] text-gray-400">+{responsibilities.filter(Boolean).length - 3} more</p>}
              </div>
            </div>
            ...
            <div className="flex justify-between pt-2">
              ...
              <div className="flex gap-3">
                <button onClick={() => window.location.href = `/${locale}/admin/jobs`}
                  className="px-5 py-2.5 border border-gray-200 text-gray-600 text-sm rounded-lg hover:bg-gray-50">Cancel</button>

...
export function FinalCTASection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#1565C0] via-[#2196F3] to-[#1976D2] dark:from-gray-900 dark:via-blue-950 dark:to-gray-900 relative overflow-hidden">
      {/* Orange accent blobs */}

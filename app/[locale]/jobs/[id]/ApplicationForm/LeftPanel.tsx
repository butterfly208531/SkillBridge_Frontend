const LeftPanel = () => {
  return (
    <div
      ...
      style={{ background: 'linear-gradient(160deg, #1565C0 0%, #0D47A1 50%, #1a237e 100%)' }}
    >
      ...
      <div className='relative z-10 px-10 pt-14'>
        <h2 className='text-4xl font-black text-white leading-tight'>
          Apply for
          <br />
          <span className='text-[#F57C00]'>Your Dream Job</span>
        </h2>
        <p className='text-white/70 text-sm mt-3 leading-relaxed'>
          Take the next step in your career. Join top companies through SkillBridge job opportunities.
        </p>
      </div>
        ...
        <div className='relative w-72 h-48'>
          <div className='absolute left-0 top-4 w-28 h-36 rounded-2xl overflow-hidden shadow-xl rotate-[-18deg] origin-bottom'
            ...
            <div className='p-3 text-white'>
              <div className='text-[10px] font-bold uppercase tracking-wider opacity-80'>Remote</div>
              <div className='text-sm font-black mt-1'>Work Anywhere</div>
            </div>
          </div>
          <div className='absolute left-8 top-2 w-28 h-36 rounded-2xl overflow-hidden shadow-xl rotate-[-9deg] origin-bottom bg-white'>
            <div className='p-3'>
              <div className='text-[10px] font-bold uppercase tracking-wider text-gray-400'>Career</div>
              <div className='text-sm font-black mt-1 text-gray-800'>Growth</div>
            </div>
          </div>
          <div className='absolute left-16 -top-2 w-32 h-40 rounded-2xl overflow-hidden shadow-2xl z-10'
            style={{ background: 'linear-gradient(135deg,#1565C0,#2196F3)' }}>
            <div className='p-4 text-white'>
              <div className='text-[10px] font-bold uppercase tracking-wider opacity-80'>2026</div>
              <div className='text-base font-black mt-1'>SkillBridge<br />Careers</div>
            </div>
          </div>
          <div className='absolute right-8 top-2 w-28 h-36 rounded-2xl overflow-hidden shadow-xl rotate-[9deg] origin-bottom'
            ...
            <div className='p-3 text-white'>
              <div className='text-[10px] font-bold uppercase tracking-wider opacity-80'>Tech</div>
              <div className='text-sm font-black mt-1'>Innovation</div>
            </div>
          </div>
          <div className='absolute right-0 top-4 w-28 h-36 rounded-2xl overflow-hidden shadow-xl rotate-[18deg] origin-bottom'
            ...
            <div className='p-3 text-white'>
              <div className='text-[10px] font-bold uppercase tracking-wider opacity-80'>Hire</div>
              <div className='text-sm font-black mt-1'>Top Talent</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='relative z-10 mx-6 mb-10 rounded-2xl p-5'
        ...
        <ul className='space-y-2 mb-4'>
          {['Top partner companies', 'Competitive salaries', 'Career growth opportunities'].map((item) => (
